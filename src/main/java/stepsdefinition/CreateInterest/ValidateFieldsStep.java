...
public class ValidateFieldsStep {
  ...
  @When("I create interest using: key {string} with value {string}")
  public void whenISendTheRequest(String key, String value) throws Throwable {
	  File original= new File("D:\\AutomationTest\\02Projects\\HANUBankingAPIAutomation\\src\\main\\resources\\CreateInterest\\CreateInterestData.json");
	  File destination= new File("D:\\AutomationTest\\02Projects\\HANUBankingAPIAutomation\\src\\main\\resources\\CreateInterest\\CreateInterestDataCopy.json");
